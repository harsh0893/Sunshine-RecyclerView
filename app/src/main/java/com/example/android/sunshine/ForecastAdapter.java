...
//      TODO (7) Replace the single TextView with Views to display all of the weather info
       ...
       int imagePath = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
        ...
        forecastAdapterViewHolder.tv_day.setText(dateString);
        forecastAdapterViewHolder.tv_description.setText(description);
        forecastAdapterViewHolder.tv_low_temp.setText(lowTemperature);
        forecastAdapterViewHolder.tv_high_temp.setText(highTemperature);


        forecastAdapterViewHolder.iv_weather_image.setImageResource(imagePath);
...
//      TODO (4) Replace the weatherSummary TextView with individual weather detail TextViews
        ...
        final ImageView iv_weather_image;
        final TextView tv_low_temp;
        final TextView tv_high_temp;
...
//          TODO (6) Get references to all new views and delete this line
            ...
            iv_weather_image = (ImageView) view.findViewById(R.id.iv_weather_image);
            tv_low_temp = (TextView) view.findViewById(R.id.tv_low_temp);
            tv_high_temp = (TextView) view.findViewById(R.id.tv_high_temp);
